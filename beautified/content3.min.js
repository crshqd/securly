        ...
        if (-1 != document.location.hostname.indexOf("youtube")) {
            ...
            new MutationObserver(function(e) {
                e.some(function(e) {
                    ...
                    (n = (n = n.replace(/^\([0-9]{0,}\)\s/, "")).replace(/ +/g, " ")) != t && -1 != document.URL.indexOf("results?search_query") && (searchFlaggedData(n), t = n)
                })
            }).observe(e, {
                subtree: !0,
                characterData: !0,
...
function sepCheckTitle(e) {
    ...
    } else - 1 != document.location.hostname.indexOf("bing") && (t = t.toLowerCase().replace(" - search", " - bing"));
    searchFlaggedData(t)
}
    ...
    for (let n = 0; n < shContent.length; n++) {
        if (-1 != e.toLowerCase().indexOf("google")) {
            ...
            if (o && (indexStr = o.innerHTML.toLowerCase().indexOf(shContent[n].toLowerCase()), -1 != indexStr)) {
                ...
                t || sendSHData(e.toLowerCase().replace("- google search", "").trim(), r, shContent[n], sepCleanDomainName(document.domain)), t = !0
            }
            ...
            if (o && (indexStr = o.innerHTML.toLowerCase().indexOf(shContent[n].toLowerCase()), -1 != indexStr)) {
                let a = Array.from(o.getElementsByTagName("a")),
                    r = a.length > 0 ? a[0].href : "";
                t || sendSHData(e.toLowerCase().replace("- bing", "").trim(), r, shContent[n], sepCleanDomainName(document.domain)), t = !0
            }
            ...
            if (o && (indexStr = o.innerHTML.toLowerCase().indexOf(shContent[n].toLowerCase()), -1 != indexStr)) {
                let a = Array.from(o.getElementsByTagName("a")),
                    r = a.length > 0 ? a[0].href : "";
                t || sendSHData(e.toLowerCase().replace("- yahoo search results", "").trim(), r, shContent[n], sepCleanDomainName(document.domain)), t = !0
            }
            ...
            if (o && (indexStr = o.innerHTML.toLowerCase().indexOf(shContent[n].toLowerCase()), -1 != indexStr)) {
                let a = Array.from(o.getElementsByTagName("a")),
                    r = a.length > 0 ? a[0].href : "";
                t || sendSHData(e.toLowerCase().replace("- youtube", "").trim(), r, shContent[n], sepCleanDomainName(document.domain)), t = !0
            }
        }
        if (t) break
    }
...
sepPort.onMessage.addListener(function(e) {
    shContent = e
}), window.addEventListener ? window.addEventListener("load", sepCallWindowLoadWithTimeOut, !1) : window.attachEvent && window.attachEvent("onload", sepCallWindowLoadWithTimeOut);