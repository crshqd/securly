...
function ENCRYPT(e) {
    ...
    var n, r, i, a, s, c, l, d, u, h = new Array(80),
        g = 1732584193,
        w = 4023233417,
        f = 2562383102,
        m = 271733878,
    ...
    for (y.push(v >>> 29), y.push(v << 3 & 4294967295), n = 0; n < y.length; n += 16) {
        ...
        for (a = g, s = w, c = f, l = m, d = p, r = 0; r <= 19; r++) u = t(a, 5) + (s & c | ~s & l) + d + h[r] + 1518500249 & 4294967295, d = l, l = c, c = t(s, 30), s = a, a = u;
        for (r = 20; r <= 39; r++) u = t(a, 5) + (s ^ c ^ l) + d + h[r] + 1859775393 & 4294967295, d = l, l = c, c = t(s, 30), s = a, a = u;
        for (r = 40; r <= 59; r++) u = t(a, 5) + (s & c | s & l | c & l) + d + h[r] + 2400959708 & 4294967295, d = l, l = c, c = t(s, 30), s = a, a = u;
        for (r = 60; r <= 79; r++) u = t(a, 5) + (s ^ c ^ l) + d + h[r] + 3395469782 & 4294967295, d = l, l = c, c = t(s, 30), s = a, a = u;
        g = g + a & 4294967295, w = w + s & 4294967295, f = f + c & 4294967295, m = m + l & 4294967295, p = p + d & 4294967295
    }
    return (u = o(g) + o(w) + o(f) + o(m) + o(p)).toLowerCase()
}
...
function rebrokerLoadedTabs(e) {
    e = void 0 === e ? "" : e, chrome.tabs.query({}, function(t) {
        for (var o = 0; o < t.length; o++) t[o].id != e && (checkDomain(t[o].url, "securly.com") || -1 == t[o].url.indexOf("http://") && -1 == t[o].url.indexOf("https://") || (t[o].initiator = "", t[o].type = "main_frame", t[o].method = "GET", t[o].tabId = t[o].id, onBeforeRequestListener(t[o], !0)))
    })
}
            ...
            g = a.BufferedBlockAlgorithm = s.extend({
                ...
                _process: function(t) {
                    ...
                    if (l) {
                        ...
                        o = r.splice(0, l), n.sigBytes -= d
                    }
                    return new c.init(o, d)
                },
                clone: function() {
                    var e = s.clone.call(this);
    ...
    return function() {
        ...
        function(e) {
            ...
            _doProcessBlock: function(e, t) {
                for (var o = this._hash.words, n = o[0], i = o[1], a = o[2], s = o[3], c = o[4], l = 0; l < 80; l++) {
                    ...
                    u += l < 20 ? 1518500249 + (i & a | ~i & s) : l < 40 ? 1859775393 + (i ^ a ^ s) : l < 60 ? (i & a | i & s | a & s) - 1894007588 : (i ^ a ^ s) - 899497514, c = s, s = a, a = i << 30 | i >>> 2, i = n, n = u
                }
        ...
        function(e) {
            ...
            var c = [],
                d = i.SHA256 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var o = this._hash.words, n = o[0], r = o[1], i = o[2], a = o[3], l = o[4], d = o[5], u = o[6], h = o[7], g = 0; g < 64; g++) {
                            if (g < 16) c[g] = 0 | e[t + g];
                            else {
                                var w = c[g - 15],
                            ...
                            var v = n & r ^ n & i ^ r & i,
                                ...
                                b = h + ((l << 26 | l >>> 6) ^ (l << 21 | l >>> 11) ^ (l << 7 | l >>> 25)) + (l & d ^ ~l & u) + s[g] + c[g];
                            h = u, u = d, d = l, l = a + b | 0, a = i, i = r, r = n, n = b + (y + v) | 0
                        }
                        o[0] = o[0] + n | 0, o[1] = o[1] + r | 0, o[2] = o[2] + i | 0, o[3] = o[3] + a | 0, o[4] = o[4] + l | 0, o[5] = o[5] + d | 0, o[6] = o[6] + u | 0, o[7] = o[7] + h | 0
                    },
                    _doFinalize: function() {
                        var t = this._data,
                            o = t.words,
            ...
            var t = l,
                ...
                g = i.RIPEMD160 = r.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        ...
                        for (o = 0; o < 80; o += 1) B = i + e[t + N[o]] | 0, B += o < 16 ? w(l, g, b) + x[0] : o < 32 ? f(l, g, b) + x[1] : o < 48 ? m(l, g, b) + x[2] : o < 64 ? p(l, g, b) + x[3] : v(l, g, b) + x[4], B = (B = y(B |= 0, A[o])) + k | 0, i = k, k = b, b = y(g, 10), g = l, l = B, B = _ + e[t + D[o]] | 0, B += o < 16 ? v(S, O, C) + U[0] : o < 32 ? p(S, O, C) + U[1] : o < 48 ? m(S, O, C) + U[2] : o < 64 ? f(S, O, C) + U[3] : w(S, O, C) + U[4], B = (B = y(B |= 0, I[o])) + L | 0, _ = L, L = C, C = y(O, 10), O = S, S = B;
            ...
            var e = l,
                ...
                s = r.PBKDF2 = o.extend({
                    ...
                    compute: function(e, t) {
                        for (var o = this.cfg, r = a.create(o.hasher, e), i = n.create(), s = n.create([1]), c = i.words, l = s.words, d = o.keySize, u = o.iterations; c.length < d;) {
                            var h = r.update(t).finalize(s);
                            r.reset();
                            for (var g = h.words, w = g.length, f = h, m = 1; m < u; m++) {
                ...
                a = r.EvpKDF = o.extend({
                    ...
                    compute: function(e, t) {
                        for (var o, r = this.cfg, i = r.hasher.create(), a = n.create(), s = a.words, c = r.keySize, l = r.iterations; s.length < c;) {
                            ...
                            for (var d = 1; d < l; d++) o = i.finalize(o), i.reset();
                            a.concat(o)
                        }
        ...
        function(e) {
            ...
            var h = a.SHA3 = r.extend({
                        ...
                        for (h = 0; h < 5; h++)
                            for (f = 0; f < 5; f++) {
                                var R = o[k = h + 5 * f],
                                    ...
                                    U = u[(h + 1) % 5 + 5 * f],
                                    N = u[(h + 2) % 5 + 5 * f];
                                R.high = x.high ^ ~U.high & N.high, R.low = x.low ^ ~U.low & N.low
                            }
                        R = o[0];
                        var D = d[l];
                ...
                _doFinalize: function() {
                    ...
                    for (var a = this._state, s = this.cfg.outputLength / 8, c = s / 8, l = [], d = 0; d < c; d++) {
                        var u = a[d],
                            h = u.high,
                            g = u.low;
        ...
        function() {
            ...
            var d = i.SHA512 = t.extend({
                ...
                _doProcessBlock: function(e, t) {
                    for (var o = this._hash.words, n = o[0], r = o[1], i = o[2], a = o[3], l = o[4], d = o[5], u = o[6], h = o[7], g = n.high, w = n.low, f = r.high, m = r.low, p = i.high, v = i.low, y = a.high, b = a.low, k = l.high, _ = l.low, S = d.high, O = d.low, C = u.high, L = u.low, B = h.high, R = h.low, x = g, U = w, N = f, D = m, A = p, I = v, E = y, T = b, H = k, F = _, P = S, M = O, q = C, W = L, z = B, j = R, V = 0; V < 80; V++) {
                        var G, K, Y = c[V];
                        if (V < 16) K = Y.high = 0 | e[t + 2 * V], G = Y.low = 0 | e[t + 2 * V + 1];
                            ...
                            var J = c[V - 15],
                                ...
                                le = ce.high,
                                de = ce.low;
                            K = (K = (K = $ + ae + ((G = Q + se) >>> 0 < Q >>> 0 ? 1 : 0)) + ne + ((G += re) >>> 0 < re >>> 0 ? 1 : 0)) + le + ((G += de) >>> 0 < de >>> 0 ? 1 : 0), Y.high = K, Y.low = G
                        }
                        var ue, he = H & P ^ ~H & q,
                            ge = F & M ^ ~F & W,
                            we = x & N ^ x & A ^ N & A,
                            fe = U & D ^ U & I ^ D & I,
                            me = (x >>> 28 | U << 4) ^ (x << 30 | U >>> 2) ^ (x << 25 | U >>> 7),
                            pe = (U >>> 28 | x << 4) ^ (U << 30 | x >>> 2) ^ (U << 25 | x >>> 7),
                            ve = (H >>> 14 | F << 18) ^ (H >>> 18 | F << 14) ^ (H << 23 | F >>> 9),
                            ye = (F >>> 14 | H << 18) ^ (F >>> 18 | H << 14) ^ (F << 23 | H >>> 9),
                            be = s[V],
                            ke = be.high,
                            _e = be.low,
                            Se = z + ve + ((ue = j + ye) >>> 0 < j >>> 0 ? 1 : 0),
                            Oe = pe + fe;
                        z = q, j = W, q = P, W = M, P = H, M = F, H = E + (Se = (Se = (Se = Se + he + ((ue = ue + ge) >>> 0 < ge >>> 0 ? 1 : 0)) + ke + ((ue = ue + _e) >>> 0 < _e >>> 0 ? 1 : 0)) + K + ((ue = ue + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((F = T + ue | 0) >>> 0 < T >>> 0 ? 1 : 0) | 0, E = A, T = I, A = N, I = D, N = x, D = U, x = Se + (me + we + (Oe >>> 0 < pe >>> 0 ? 1 : 0)) + ((U = ue + Oe | 0) >>> 0 < ue >>> 0 ? 1 : 0) | 0
                    }
                    w = n.low = w + U, n.high = g + x + (w >>> 0 < U >>> 0 ? 1 : 0), m = r.low = m + D, r.high = f + N + (m >>> 0 < D >>> 0 ? 1 : 0), v = i.low = v + I, i.high = p + A + (v >>> 0 < I >>> 0 ? 1 : 0), b = a.low = b + T, a.high = y + E + (b >>> 0 < T >>> 0 ? 1 : 0), _ = l.low = _ + F, l.high = k + H + (_ >>> 0 < F >>> 0 ? 1 : 0), O = d.low = O + M, d.high = S + P + (O >>> 0 < M >>> 0 ? 1 : 0), L = u.low = L + W, u.high = C + q + (L >>> 0 < W >>> 0 ? 1 : 0), R = h.low = R + j, h.high = B + z + (R >>> 0 < j >>> 0 ? 1 : 0)
                },
                _doFinalize: function() {
                    var e = this._data,
                        t = e.words,
        ...
        function() {
            ...
            ! function() {
                ...
                for (t = 0; t < 256; t++) {
                    ...
                    d[w] = v << 24 | v >>> 8, u[w] = v << 16 | v >>> 16, h[w] = v << 8 | v >>> 24, g[w] = v, o ? (o = f ^ e[e[e[p ^ f]]], l ^= e[e[l]]) : o = l = 1
                }
            }();
            var w = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                f = o.AES = t.extend({
                    _doReset: function() {
                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                            ...
                            for (var s = this._invKeySchedule = [], c = 0; c < r; c++) {
                                ...
                                s[c] = c < 4 || a <= 4 ? l : d[n[l >>> 24]] ^ u[n[l >>> 16 & 255]] ^ h[n[l >>> 8 & 255]] ^ g[n[255 & l]]
                            }
                        }
                    },
                    ...
                    decryptBlock: function(e, t) {
                        var o = e[t + 1];
                        e[t + 1] = e[t + 3], e[t + 3] = o, this._doCryptBlock(e, t, this._invKeySchedule, d, u, h, g, r);
                        o = e[t + 1];
                        e[t + 1] = e[t + 3], e[t + 3] = o
                    },
                    _doCryptBlock: function(e, t, o, n, r, i, a, s) {
                        for (var c = this._nRounds, l = e[t] ^ o[0], d = e[t + 1] ^ o[1], u = e[t + 2] ^ o[2], h = e[t + 3] ^ o[3], g = 4, w = 1; w < c; w++) {
                            var f = n[l >>> 24] ^ r[d >>> 16 & 255] ^ i[u >>> 8 & 255] ^ a[255 & h] ^ o[g++],
                                m = n[d >>> 24] ^ r[u >>> 16 & 255] ^ i[h >>> 8 & 255] ^ a[255 & l] ^ o[g++],
                                p = n[u >>> 24] ^ r[h >>> 16 & 255] ^ i[l >>> 8 & 255] ^ a[255 & d] ^ o[g++],
                                v = n[h >>> 24] ^ r[l >>> 16 & 255] ^ i[d >>> 8 & 255] ^ a[255 & u] ^ o[g++];
                            l = f, d = m, u = p, h = v
                        }
                        f = (s[l >>> 24] << 24 | s[d >>> 16 & 255] << 16 | s[u >>> 8 & 255] << 8 | s[255 & h]) ^ o[g++], m = (s[d >>> 24] << 24 | s[u >>> 16 & 255] << 16 | s[h >>> 8 & 255] << 8 | s[255 & l]) ^ o[g++], p = (s[u >>> 24] << 24 | s[h >>> 16 & 255] << 16 | s[l >>> 8 & 255] << 8 | s[255 & d]) ^ o[g++], v = (s[h >>> 24] << 24 | s[l >>> 16 & 255] << 16 | s[d >>> 8 & 255] << 8 | s[255 & u]) ^ o[g++];
        ...
        function() {
                ...
                u = r.DES = n.extend({
                    _doReset: function() {
                        ...
                        for (var r = this._subKeys = [], c = 0; c < 16; c++) {
                            var l = r[c] = [],
                                d = s[c];
                            for (o = 0; o < 24; o++) l[o / 6 | 0] |= t[(a[o] - 1 + d) % 28] << 31 - o % 6, l[4 + (o / 6 | 0)] |= t[28 + (a[o + 24] - 1 + d) % 28] << 31 - o % 6;
                            l[0] = l[0] << 1 | l[0] >>> 31;
                            for (o = 1; o < 7; o++) l[o] = l[o] >>> 4 * (o - 1) + 3;
                            l[7] = l[7] << 5 | l[7] >>> 27
                        }
                        var u = this._invSubKeys = [];
                        for (o = 0; o < 16; o++) u[o] = r[15 - o]
                    },
                    encryptBlock: function(e, t) {
                    ...
                    _doCryptBlock: function(e, t, o) {
                        ...
                        for (var n = 0; n < 16; n++) {
                            for (var r = o[n], i = this._lBlock, a = this._rBlock, s = 0, l = 0; l < 8; l++) s |= c[l][((a ^ r[l]) & d[l]) >>> 0];
                            this._lBlock = a, this._rBlock = i ^ s
                        }
                        var u = this._lBlock;
                        this._lBlock = this._rBlock, this._rBlock = u, h.call(this, 1, 1431655765), g.call(this, 8, 16711935), g.call(this, 2, 858993459), h.call(this, 16, 65535), h.call(this, 4, 252645135), e[t] = this._lBlock, e[t + 1] = this._rBlock
                    },
                    keySize: 2,
                    ivSize: 2,
                    blockSize: 2
            ...
            var w = r.TripleDES = n.extend({
                _doReset: function() {
                    ...
                    this._des1 = u.createEncryptor(o.create(t)), this._des2 = u.createEncryptor(o.create(n)), this._des3 = u.createEncryptor(o.create(r))
                },
                encryptBlock: function(e, t) {
                    ...
                    _doReset: function() {
                        ...
                        if (t) {
                            var i = t.words,
                                ...
                                u = l >>> 16 | 4294901760 & d,
                                h = d << 16 | 65535 & l;
                            r[0] ^= l, r[1] ^= u, r[2] ^= d, r[3] ^= h, r[4] ^= l, r[5] ^= u, r[6] ^= d, r[7] ^= h;
                            for (o = 0; o < 4; o++) a.call(this)
                        }
                    },
                    _doProcessBlock: function(e, t) {
                    ...
                    _doReset: function() {
                        ...
                        if (t) {
                            var i = t.words,
                                ...
                                u = l >>> 16 | 4294901760 & d,
                                h = d << 16 | 65535 & l;
                            n[0] ^= l, n[1] ^= u, n[2] ^= d, n[3] ^= h, n[4] ^= l, n[5] ^= u, n[6] ^= d, n[7] ^= h;
        ...
        ! function(n) {
            ...
            r.fromInt = function(e, t) {
                ...
                for (var i = r.fromNumber(Math.pow(o, 8)), a = r.ZERO, s = 0; s < e.length; s += 8) {
                    ...
                    if (c < 8) {
                        var d = r.fromNumber(Math.pow(o, c));
                        a = a.multiply(d).add(r.fromNumber(l))
            ...
            r.ZERO = r.fromInt(0), r.UZERO = r.fromInt(0, !0), r.ONE = r.fromInt(1), r.UONE = r.fromInt(1, !0), r.NEG_ONE = r.fromInt(-1), r.MAX_VALUE = r.fromBits(-1, 2147483647, !1), r.MAX_UNSIGNED_VALUE = r.fromBits(-1, -1, !0), r.MIN_VALUE = r.fromBits(0, -2147483648, !1), r.prototype.toInt = function() {
                ...
                var t = this.high >>> 16,
                    ...
                    u = 0,
                    h = 0;
                return u += (h += i + (65535 & e.low)) >>> 16, d += (u += n + c) >>> 16, l += (d += o + s) >>> 16, l += t + a, r.fromBits((u &= 65535) << 16 | (h &= 65535), (l &= 65535) << 16 | (d &= 65535), this.unsigned)
                ...
                var t = this.high >>> 16,
                    ...
                    g = 0,
                    w = 0;
                return g += (w += i * l) >>> 16, h += (g += n * l) >>> 16, g &= 65535, h += (g += i * c) >>> 16, u += (h += o * l) >>> 16, h &= 65535, u += (h += n * c) >>> 16, h &= 65535, u += (h += i * s) >>> 16, u += t * l + o * c + n * s + i * a, r.fromBits((g &= 65535) << 16 | (w &= 65535), (u &= 65535) << 16 | (h &= 65535), this.unsigned)
    ...
    if (doBrokerForClassroom() && (l = ""), l)
        if (-1 != l.indexOf("ALLOW") && 0 == skipCacheAndLogAlways(e, o)) wellPathWidgBg.triggerWidgetDisplay();
            ...
            let a = null,
                h = null,
                g = null;
            if (selfClusterCheckBeforeBroker(), null != s && (h = s.channelId, a = s.videoId, g = s.category), d = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (i ? "&subframe=1" : "") + ("" != r ? "&frameHost=" + r : "") + (null != h ? "&channelID=" + h : "") + (null != a ? "&videoID=" + a : "") + (null != g ? "&category=" + encodeURIComponent(g) : "") + "&extension_id=" + chrome.runtime.id + "&internal_ip=" + window.currentUserInternalIp, c && (d += "&rebroker=1"), 0 == l.indexOf("SS") && stripSafeSearchPramas(o) == window.lastBrokeredRequest) return l.split(":");
            if (window.lastBrokeredRequest = o, "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
                (u = createNonBlockingRequest("get", d)).onerror = function() {
                    l = "ERROR:-1:-1:-1:-1:-1:-1"
                }, u.onload = function() {
                    if (void 0 !== c && c || setClearCacheCookie(n), wellPathWidgBg.triggerWidgetDisplay(), 0 != (l = u.responseText.trim()).indexOf("FAILED_OPEN:")) {
                        if (-1 == l.toLowerCase().indexOf("<html")) {
                            var o = l.split(":"),
                                ...
                                h = !1;
                            if (0 == isNaN(d) && d >= 0) {
                                var g = Long.fromString(d, !0).shiftRight(0).toNumber(),
                                    w = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                                Long.fromNumber(g).and(Math.pow(2, 36)).shiftRight(0).toNumber() == w && (h = !0)
                            }
                            if ("DENY" != r && "PAUSE" != r) try {
                                putURLCache(l, t, e, h)
                            } catch (e) {
                                sessionStorage.clear()
                            } else "DENY" == r ? takeDenyActionTabs(i, a, s, t, n, 0, c) : "PAUSE" == r && takePauseActionTabs(t, n)
                        }
                    } else {
                        var f = l.split(":");
                        window.failedOpenObj = new FailedOpen(f[1], f[2])
                    }
                };
                try {
                    u.send()
        ...
        if (selfClusterCheckBeforeBroker(), null != s && (g = s.channelId, h = s.videoId, w = s.category), d = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (i ? "&subframe=1" : "") + ("" != r ? "&frameHost=" + r : "") + (null != g ? "&channelID=" + g : "") + (null != h ? "&videoID=" + h : "") + (null != w ? "&category=" + encodeURIComponent(w) : "") + "&extension_id=" + chrome.runtime.id + "&internal_ip=" + window.currentUserInternalIp, window.geolocation && (d = d + "&lat=" + window.geoLat + "&lng=" + window.geoLng), c && (d += "&rebroker=1"), 0 == i) {
            if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var u = createNonBlockingRequest("get", d)
        } else {
            let t = !1;
            if (isSeachRequest(e, o) && stripSafeSearchPramas(o) == window.lastBrokeredRequest && (t = !0), window.lastBrokeredRequest = o, !t && "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var u = createBlockingRequest("get", d)
        }
        if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            u.onerror = function() {
                l = "ERROR:-1:-1:-1:-1:-1:-1"
            }, u.onload = function() {
                if (0 != (l = u.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    null != window.failedOpenObj && (window.failedOpenObj = null);
                    var o = l.split(":")[2];
                    findCrextnBasegene(l), window.checkiFrames = l.split(":")[7];
                    var s = !1;
                    if (0 == isNaN(o) && o >= 0) {
                        var d = Long.fromString(o, !0).shiftRight(0).toNumber(),
                            h = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                        Long.fromNumber(d).and(Math.pow(2, 36)).shiftRight(0).toNumber() == h && (s = !0)
                    }
                    if (void 0 !== c && c || setClearCacheCookie(n), wellPathWidgBg.triggerWidgetDisplay(), setClassroomCookies(), -1 == l.indexOf("DENY") && -1 == l.indexOf("PAUSE")) try {
                            putURLCache(l, t, e, s), setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5)
                        } catch (e) {
                            sessionStorage.clear()
                        ...
                        var g = l.split(":"),
                            ...
                            m = g[3];
                        g[4], g[5], g[6];
                        0 == i || 0 == window.checkiFrames ? (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, f, m, t, n, isSubFrame, c)) : 1 == window.checkiFrames && (a.iframeResp = g, "" !== r && window.atob(t) !== r ? (a.iframeBlockUrl = "", isSubFrame = !0, window.isSubFrame = !0, a.iframeBlockUrl = getBlockUrl(w, f, m, t, isSubFrame), iframeDenyResp = g) : (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, f, m, t, n, isSubFrame, c)))
                    }
                } else {
                    ...
                    if (window.failedOpenObj = new FailedOpen(p[1], p[2]), !window.failedOpenObj.isWideOpenMode()) {
                        ...
                        null == y || window.featureConfig.isDiscernMode || takeToFailedOpenBlockedPage(n, e, y)
                    }
                }
            };
            try {
...
function getRespArr(e, t, o, n = "", r = !1) {
    ...
    if (doBrokerForClassroom() && (i = ""), i) wellPathWidgBg.triggerWidgetDisplay();
        ...
        s.onerror = function() {
            ...
            if (wellPathWidgBg.triggerWidgetDisplay(), setClearCacheCookie(), setClassroomCookies(), 0 != (i = s.responseText.trim()).indexOf("FAILED_OPEN:")) {
                var n = i.split(":")[2];
    ...
    chrome.tabs.onCreated.addListener(function(e) {
        ...
        if (e.requestHeaders.forEach(function(e) {
            ...
            if ("mail.google.com" === (i = normalizeHostname(i))) {
                ...
                if (a)
                    if ("GM" == (d = a.split(":"))[0]) return e.requestHeaders.push({
            ...
            if (1 == n) {
                ...
                if ("sub_frame" == e.type ? (c = !0, window.isSubFrame = !0, window.brokredRequest = []) : (window.isSubFrame = !1, c = !1, window.youtubeFrames = []), checkDomain(o, "youtube.com") && !1 === window.checkYouTube || !checkDomain(o, "youtube.com") || e.initiator !== window.refDomain) var d = getRespArr(i, r, o, s, c);
                var u = d[0],
                    h = (d[1], d[2]),
                    g = (d[3], d[4]),
                    w = d[4];
                ...
                return this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] ? (this.iframeResp = "", {
                    cancel: !0
                }) : (checkDomain(o, "youtube.com") && "REFWL" == h ? (window.refDomain = e.initiator, window.checkYouTube = !1) : checkDomain(o, "youtube.com") && (window.checkYouTube = !0), "GM" == u ? (e.requestHeaders.push({
                    name: "X-GoogApps-Allowed-Domains",
                    value: w
                }), {
                    requestHeaders: e.requestHeaders
                }) : "YT" == u && !0 === window.checkYouTube ? (2 == g ? e.requestHeaders.push({
        ...
        if ("outermost_frame" === e.frameType && checkDomain(t, "webpkgcache.com")) {
            let o = t.pathname && "string" == typeof t.pathname && t.pathname.match(/\/([^\/]+)\/$/),
                n = o && o.length > 1 ? o[1] : "";
            if ("" == n) return;
            let r = "https://" + n,
                i = btoa(r),
            ...
            let c = getRespArrTabs(lHostName, i, r, e.tabId, "", !1, this),
                ...
                d = c[1],
                u = c[2];
            "DENY" == l && chrome.tabs.update(e.tabId, takeDenyActionTabs(d, u, -1, i, e.tabId, !1, !1))
        }
    }, {
        ...
        "search_engine_parser" == e.name ? e.onMessage.addListener(function(t, o) {
            ...
            if (window.checkYouTube && "getYoutubeOptions" != t.action && (checkDomain(t.url, "youtube.com") || t.embedded) && (window.youtubeLastCheck = Date.now(), isClusterURLAvailable() && -1 === window.youtubeFrames.indexOf(e.sender.frameId) && (null != t.channelId || null != t.videoId || null != t.category))) {
                ...
                let s = "",
                    c = getRespArrTabs(lHostName, r, o.sender.url, o.sender.tab.id, s, t.embedded, this, n),
                    l = c[0],
                    d = c[1];
                c[2];
                if ("DENY" == l) {
...
function onBeforeRequestListener(e, t = !1) {
    ...
    if ("sub_frame" == e.type && "file://" == e.initiator && 0 === e.url.indexOf("http") && (i = 1), 1 == i && (i = checkSkipListCaching(e)), 1 != i);
        ...
        var l, d = window.btoa(o),
            u = o.replace(/^(?:https?:\/\/)?/i, "");
        if (u.endsWith("/") && (u = u.slice(0, -1)), window.brokeredArrIndex++, window.brokeredArrIndex >= 20 && (window.brokeredArrIndex = 0), -1 == window.brokredRequest.indexOf(u) && (window.brokredRequest[window.brokeredArrIndex] = u), l = normalizeHostname(l = checkDomain(o, "translate.google.com") ? extractTranslateHostname(o) : new URL(o).hostname), window.geolocation && getRemoteIPGeo(), checkDomain(o, "youtube.com") && !1 === window.checkYouTube || !checkDomain(o, "youtube.com") || e.initiator !== window.refDomain) var h = getRespArrTabs(l, d, o, e.tabId, a, s, this, null, t);
        var g = h[0],
            w = h[1],
            f = h[2],
            m = (h[3], h[4], h[5], h[6], ""),
        ...
        if ("DENY" == g) return takeDenyAction(w, f, d);
        if ("PAUSE" == g) return getPauseAction(d);
        var v = !1;
        ...
        if (!0 === v) {
            ...
            if (googleDomains.indexOf(e.hostname.replace(/(^www\.)|(^\.)/, "")) >= 0) {
                if (null !== y.get("q")) {
                    ...
                    if (!1 === m && !1 === p) return;
                    if (googleDomains.indexOf(e.hostname.replace(/(^www\.)|(^\.)/, "")) >= 0 && "isch" === y.get("tbm") && "il:cl" !== y.get("tbs")) return {
                        redirectUrl: n
                    }
                }
