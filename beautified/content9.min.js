...
async function onWindowLoad() {
    ...
    for (let a = 0; a < t.snapshotLength; a++)
        if (t.snapshotItem(a).attributes.length > 0 && null != t.snapshotItem(a).attributes.src && null !== t.snapshotItem(a).attributes.src.value.match(n)) {
        ...
        for (let e = 0; e < t.snapshotLength; e++)
            if (t.snapshotItem(e).attributes.length > 0 && null != t.snapshotItem(e).getAttribute("placeholder") && "click on 'Create new session ID' or 'Fill in existing session ID' from below" == t.snapshotItem(e).getAttribute("placeholder")) {
